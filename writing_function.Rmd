...
# can set default true_mean and true_sd in the argument
sim_mean_sd(30)

# you can set default number in argument, but you can still change them, like below.
...
```{r}
nsduh_table_foramt = function(table_num, table_name) {
...
nsduh_table_foramt(1, "marj")


# it's better to define the html 
...
after creating a source folder with defined function, you can do this:
